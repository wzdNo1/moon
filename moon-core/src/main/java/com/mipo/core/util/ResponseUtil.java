...
public class ResponseUtil {
    ...
    public static Response ok() {
        Response response = Response.sucess(null);
        return response;
    }
    ...
    public static Response ok(String errmsg, Object data) {
         return Response.sucess(100,errmsg,data);
    }
    ...
    public static Response fail(int errno, String errmsg) {
        return Response.fail(errno,errmsg);
    }
    ...
    public static Response badArgumentValue() {
    ...
    public static Response unsupport() {
        return fail(503, "业务不支持");
    }

    public static Response updatedDateExpired() {
        return fail(504, "更新数据已经失效");
    }

    public static Response updatedDataFailed() {
